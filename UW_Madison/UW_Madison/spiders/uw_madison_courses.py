...
"http://guide.wisc.edu/courses/zoology/",
    ...
    def parse_httpbin( self, response ):
        ...
        #course =  response.xpath('////div[@class="sc_sccoursedescs"]/div/p/strong/span/text()').extract()
        #course = response.css('span.courseblockcode::text').extract()
        course = response.css('span.courseblockcode::text').extract_first()

        #title = response.xpath('////div[@class="sc_sccoursedescs"]/div/p/strong/text()').extract()
        ...
        #unit = response.xpath('////div[@class="sc_sccoursedescs"]/div/p[@class="courseblockcredits"]/text()').extract()
        #unit = response.css('.courseblockcredits::text').extract()
        unit = response.css('.courseblockcredits::text').extract_first()

        #description = response.xpath('////div[@class="sc_sccoursedescs"]/div/p[@class="courseblockdesc noindent"]/text()').extract()
