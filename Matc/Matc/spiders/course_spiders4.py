...
class MatcSpider( scrapy.Spider ):
    ...
    start_urls = [ 
            ...
            'https://my.madisoncollege.edu/app/catalog/listCoursesBySubject/MATC1/A/AGMECH/DEGR/',

            ]

    rules = (

            Rule( LinkExtractor(allow=('https://my.madisoncollege.edu/app/catalog/showCourse/MATC1/001588/DEGR/'))),

            Rule( LinkExtractor(allow=()), callback = 'parse_httpbin'),
